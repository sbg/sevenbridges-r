...
This package __sevenbridges__ is already on Bioconductor [devel branch](https://www.bioconductor.org/packages/3.3/bioc/html/sevenbridges.html), the release day is going to be May 4th, 2016. Please check the detailed [release schedule](https://www.bioconductor.org/developers/release-schedule/). It's also synced on [GitHub page](https://github.com/sbg/sevenbridges-r)
...
![cgc-home](https://i.imgur.com/p52wIsi.png)
...
![shinyapps-token](https://i.imgur.com/ChCBhf6.png)
...
![quickstart-flow](https://i.imgur.com/OkgB2tl.png)
...
![ggvis](https://i.imgur.com/X8M2O0T.png)

A differential expression table

![de-table](https://i.imgur.com/wQ9O3Ys.png)
...
![html-report](https://i.imgur.com/9vgBQQC.png)
![heatmap](https://i.imgur.com/l5Xgq9R.png)
...
![cgc-projects](https://i.imgur.com/oI0dXyu.png)
...
![rstudio-dir](https://i.imgur.com/Wnf015S.png)
![rstudio-file](https://i.imgur.com/OYoa6kq.png)
...
![report-tool](https://i.imgur.com/yPTNpqp.png)
...
![cgc-workflow](https://i.imgur.com/dTKvLdt.png)

And next run a task on the platform via UI like this:

![rnaseq-runtask](https://i.imgur.com/6VsC69W.png)
