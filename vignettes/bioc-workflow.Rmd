...
First download the [R markdown file](https://raw.githubusercontent.com/sbg/sevenbridges-r/master/vignettes/bioc-workflow.Rmd) of this page, so you can load it to your Rstudio or your favorite IDE to run through all examples and tweak setup.
