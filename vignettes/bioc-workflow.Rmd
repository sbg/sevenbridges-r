...
![cgc-home](http://i.imgur.com/p52wIsi.png?1)
...
![ggvis](http://i.imgur.com/X8M2O0T.png)

A differential expression table

![de-table](http://i.imgur.com/wQ9O3Ys.png)
...
![html-report](http://i.imgur.com/9vgBQQC.png)
![heatmap](http://i.imgur.com/l5Xgq9R.png)
...
![cgc-projects](http://i.imgur.com/oI0dXyu.png)
...
![rstudio-dir](http://i.imgur.com/Wnf015S.png)
![rstudio-file](http://i.imgur.com/OYoa6kq.png)
...
![report-tool](http://i.imgur.com/yPTNpqp.png)
...
![cgc-workflow](http://i.imgur.com/dTKvLdt.png)

And next run a task on the platform via UI like this:

![rnaseq-runtask](http://i.imgur.com/6VsC69W.png)
