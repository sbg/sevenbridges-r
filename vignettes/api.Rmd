...
Running tasks with spot instances could potentially reduce a considerable
amount of computational cost. This option can be controlled on the project
level or the task level. This package follows the same logic as our platform's
web interface.
