...
+------------------------------------+------------------------------------------+---------------+
| DataSTAGE Powered by Seven Bridges | `https://f4c-api.sbgenomics.com/v2`      | `"f4c"`       |
+------------------------------------+------------------------------------------+---------------+
...
This example shows how to return all files with the tag "s1" __OR__ "s2".
...
#### Upload files via a defined manifest file
...
objects are still represented using the same class as the file
...
On Seven Bridges platforms, when you create or update your tools in the GUI, there
is a test tab allow users to tweak the parameters and see what it looks like in
your command line simulated terminal. To do this via R when you push your Tool object
