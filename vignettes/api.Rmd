...
## get app input names and types
app$input_type()
## get app output names and types
app$output_type()
...
```{r}
fastqs <- c("SRR924146_1.fastq", "SRR924146_2.fastq")
...
```{r}
f1 = p$file(name = "SRR924146_1.fastq", exact = TRUE)
f2 = p$file(name = "SRR924146_2.fastq", exact = TRUE)
## get all 2 exact files
fastq_in = list(f1, f2) 

## or if you know you only have 2 file name matching SRR924146*.fastq
fastq_in = p$file(name = "SRR924146*.fastq", complete = TRUE)
```
...
```{r}
fastqs <- c("SRR924146_1.fastq", "SRR924146_2.fastq", "SRR924528_1.fastq", 
            "SRR924528_2.fastq", "SRR924537_1.fastq", "SRR924537_2.fastq", 
            "SRR924538_1.fastq", "SRR924538_2.fastq")
