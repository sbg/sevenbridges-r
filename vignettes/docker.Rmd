...
function is `runif()`, it's a native function in R. 
...
At the beginning of the commadn line script, I use the docopt standard to write my tool help. 
...
There are more examples under 'inst/docker' folder, you can check out how to
describe  command line and build docker, how to make report template.
You may read the online GitHub [code](https://github.com/sbg/sevenbridges-r/tree/master/inst/docker).
Or you could read another tutorial about how we wrap RNA-seq workflow from bioconductor. 
