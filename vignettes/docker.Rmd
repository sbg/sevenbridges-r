---
title: "Creating Your Docker App with Command Line Interfqce and Auto-build on Dockerhub"
output:
...
Create an command line interaface to pass `params` from docopt into `rmarkdown::render()` function. In this way, we can pass as many as possible parameters from command line interface into our Rmarkdown template. 
