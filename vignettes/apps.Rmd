...
Workflow interface is still under development, to construct the workflow easily, it's alwasy better to just use our graphical interface, it's much easier for complex worklfow. 
