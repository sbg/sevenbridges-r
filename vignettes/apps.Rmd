...
#### More example with file/files as input node
...
#### Import JSON to Tool and Workflow object

Please use convert_app, it will automatically convert a json cwl to a R object Tool
or Workflow based on class.
