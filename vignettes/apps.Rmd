...
For complete example, please check the "Make the best of bioconductor workflow" tutorial, or if you are advanced user, you can simply check `inst/docker` folder or check the github example [here](https://github.com/tengfei/sevenbridges/tree/master/inst/docker/rnaseqGene)
...
#### Create regular input/output interface
