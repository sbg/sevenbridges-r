...
A hook is added to build the Docker image automatically from the [sevenbridges-r GitHub repository](https://github.com/sbg/sevenbridges-r/tree/master/inst/docker/sevenbridges). It is automatically built on [Docker Hub](https://hub.docker.com/r/tengfei/sevenbridges/). You can directly use this image `tengfei/sevenbridges`. Everytime a push is made in the GitHub repo, the Docker container is re-built.
