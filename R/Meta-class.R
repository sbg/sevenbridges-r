...
file_extension <- setMetaClass("file_extension", type = "characterORNULL",
                               name = "File extension",
...
platform <- setMetaClass("platform", type = "characterORNULL",
                         name = "Platform",
            ...
            See NCI Thesaurus Code: C45378.",
                         ...
                         regexErrMsg = sprintf("The Platform can contain maximum %d characters", max_chars))


sample_id <- setMetaClass("sample_id", type = "characterORNULL",
                          name =  "Sample ID",
          ...
          See NCI Thesaurus Code: C19157.",
                          locked = FALSE,
                          regex = max_length(max_chars),
                          regexErrMsg = sprintf("Sample ID can contain maximum %d characters", max_chars))



library_id <- setMetaClass("library_id", type = "characterORNULL",
                           name = "Library ID",
                           description = "An identifier for the sequencing library preparation.",
                           locked = FALSE,
                           regex = max_length(max_chars),
                           regexErrMsg = sprintf("Library ID can contain maximum %d characters", max_chars))



platform_unit_id <- setMetaClass("platform_unit_id", type = "characterORNULL",
          ...
          slide ID",
                                 locked = FALSE,
                                 regex = max_length(max_chars),
                                 regexErrMsg = sprintf("Platform unit ID can contain maximum %d characters", max_chars))
...
paired_end <- setMetaClass("paired_end",  type = "PairedEndSingleEnum",
...
file_segment_number <- setMetaClass("file_segment_number", type = "integer",
...
quality_scale_enum <- setSingleEnum("QualityScale",
...
case_uuid <- setMetaClass("case_uuid", type = "characterORNULL",
                          name =  "Case UUID",
...
primary_site <- setMetaClass("primary_site", type = "characterORNULL",
                             name = "Primary site",
...
race <- setMetaClass("race", type = "characterORNULL", 
                     name = "Race",
...
ethnicity <- setMetaClass("ethnicity", type = "characterORNULL",
                          name =  "Ethnicity",
...
sample_uuid <- setMetaClass("sample_uuid", type = "characterORNULL",
                            name = "Sample UUID",
...
sample_type <- setMetaClass("sample_type", type = "characterORNULL", 
                            name = "Sample type",
...
aliquot_id <- setMetaClass("aliquot_id", type = "characterORNULL", 
                           name = "Aliquot ID",
...
experimental_strategy <- setMetaClass("experimental_strategy", type = "characterORNULL", 
...
data_type <- setMetaClass("data_type", type = "characterORNULL", 
                          name = "Data type",
...
data_subtype <- setMetaClass("data_subtype", type = "characterORNULL", 
                             name = "Data subtype",
...
gdc_file_uuid <- setMetaClass("gdc_file_uuid", type = "characterORNULL", 
                              name = "GDC file UUID",
...
data_format <- setMetaClass("data_format", type = "characterORNULL" ,
                            name  = "Data format",
...
access_level_enum <- setSingleEnum("AccessLevel", c(NA_character_, "Controlled", "Open"))
