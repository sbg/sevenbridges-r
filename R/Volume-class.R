Volume = setRefClass("Volume", contains = "Item", 
                     ...
                     methods = list(
                         ...
                         delete = function(){
                             auth$api(path = paste0("storage/volumes/", id), method = "DELETE") 
                         },
                         import = function(location = NULL,
                             ...
                             res = auth$api(path = "storage/imports", body = body, method = "POST", ...)
                         ...
                         export = function(file = NULL, 
                             ...
                             res = auth$api(path = "storage/exports", body = body, method = "POST")
                         ...
                         get_import_job = function(job_id = NULL){
                             ...
                             if(length(import_job)){
                                 idx = which(job_id == sapply(import_job, function(x) x$id))
                                 if(length(idx)){
                                     import_job[[idx]] <<- res
                                 }else{
                                     import_job <<- c(import_job, list(res))
                         ...
                         get_export_job = function(job_id = NULL){
                             ...
                             if(length(export_job)){
                                 idx = which(job_id == sapply(export_job, function(x) x$id))
                                 if(length(idx)){
                                     export_job[[idx]] <<- res
                                 }else{
                                     export_job <<- c(export_job, list(res))
