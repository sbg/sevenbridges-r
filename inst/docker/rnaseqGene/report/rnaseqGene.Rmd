...
[Bioconductor package installation instructions](https://bioconductor.org/install/#install-bioconductor-packages).
...
[GEO entry GSE52778](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE52778).
...
```{r}
countdata <- assay(se)
write.csv(countdata, file = "count.csv")
head(countdata, 3)
```
